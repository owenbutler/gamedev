...
public class EnemyShipConstants {
    ...
    public static final int HEALTH_BLUE = 2;
    public static final int HEALTH_GOLD = 2;
    public static final int HEALTH_LBLUE = 2;
    public static final int HEALTH_SMALLBOMBER = 3;
    public static final int HEALTH_MEDGREEN = 10;
    public static final int HEALTH_MEDWATERPLANE = 10;
    public static final int HEALTH_MEDGHOST = 15;
    ...
    public static final int SHOOT_SEQUENCE_WIDE = 1;
    public static final int SHOOT_SEQUENCE_FAT = 2;

    public static final int SHOOT_SEQUENCE_MEDIUM_WIDE = 0;
    public static final int SHOOT_SEQUENCE_MEDIUM_STRAIGHT = 1;

    public static final float SHOOT_SEQUENCE_LONG_INTERVAL = 0.12f;
    public static final float SHOOT_SEQUENCE_LONG_LENGTH = 1.2f;

    public static final float SHOOT_SEQUENCE_WIDE_INTERVAL = 0.12f;
    public static final float SHOOT_SEQUENCE_WIDE_LENGTH = 1.2f;

    public static final float SHOOT_SEQUENCE_FAT_INTERVAL = 0.013f;
    public static final float SHOOT_SEQUENCE_FAT_LENGTH = 0.4f;

    public static final float SHOOT_SEQUENCE_MEDIUM_WIDE_INTERVAL = 0.1f;
    public static final float SHOOT_SEQUENCE_MEDIUM_WIDE_LENGTH = 0.5f;

    public static final float SHOOT_SEQUENCE_MEDIUM_STRAIGHT_INTERVAL = 0.1f;
    public static final float SHOOT_SEQUENCE_MEDIUM_STRAIGHT_LENGTH = 0.5f;
}
